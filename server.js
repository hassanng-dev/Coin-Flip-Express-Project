...
const url =
  "mongodb+srv://HassanNgDev:Has0424686!@cluster0.fpl4oh8.mongodb.net/coindemo?retryWrites=true&w=majority";
const dbName = "coindemo";
...
app.delete("/results", (req, res) => {
  db.collection("results").findOneAndDelete(
    { name: req.body.user, msg: req.body.msg },
    (err, result) => {
